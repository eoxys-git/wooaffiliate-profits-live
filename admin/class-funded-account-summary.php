...
class Account_summary extends WP_List_Table {
    ...
    function get_columns() {
        $columns = array(
            ...
            'account_summary'        => __( 'Account Summary', 'wooaffiliate' ),
        );
        return $columns;
    }
    ...
    function column_default( $item, $column_name) {
        ...
        $account_summary = $item['account_summary'];
        ...
        switch($column_name) {
            ...
            case 'account_summary':
             return '<a class="button button-primery" target="_blank" href="'.home_url('/my-account/funded-trader/?user_id='.$user_id).'">View</a>';
            break;
        }
    }
}